...
window.onscroll = function () {
  // Skills Offset Top بيجيب الطول من اول الصفة لغايت القسم اللي انت محدده
  let skillsOffsetTop = ourSkills.offsetTop;
  // Skills Outer Height ده بيجيب طول القسم اللي انت محدده
  let skillsOuterHeight = ourSkills.offsetHeight;
  // Window Height ده بيجيب طول الشاشة بتاعت الجهاز بتاعك اللي انت فاتح منه
  let windowHeight = this.innerHeight;
  // Window ScrollTop ده مقدار الاسكرول اللي انت بتعملة
